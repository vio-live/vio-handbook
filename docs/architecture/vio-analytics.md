# Vio Analytics — plan de implementación (v1)

> Estado: **PLAN aprobándose** (2026-07-27). Servicio propio de telemetría para toda la
> plataforma: impresiones, clicks, funnel de compra y performance de campañas, desde
> todos los SDKs (web/Vev, iOS, tvOS, Android, Android TV), coordinado con el modelo
> dinámico de vio-backend (campañas, componentes, placements, broadcasts).
