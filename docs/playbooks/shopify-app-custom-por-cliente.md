...
| Gladkokken | `wxuxre-tf.myshopify.com` (`shop.gladkokken.no`) | `426105274369` / `a372fcbd6348fc847e4f6a547518350b` | `shopify.app.vio-client-gladkokken.toml` | `vio-sync-gladkokken` → `https://vio-sync-gladkokken.vercel.app` | Link generado, config publicada (`vio-client-gladkokken-1`), 4 envs. **Faltan `SHOPIFY_API_SECRET`** (Angelo) **y conectar el Redis compartido**. En espera de feedback del cliente |
