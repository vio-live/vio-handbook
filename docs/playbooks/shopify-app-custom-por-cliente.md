...
| Makeup Mekka | `makeup-mekka.myshopify.com` (`makeupmekka.com`) | `426736517121` / `5287ee98f0381e1200754c5f16c9c914` | `shopify.app.vio-client-makeupmekka.toml` | `vio-sync-makeupmekka` → `https://vio-sync-makeupmekka.vercel.app` | Creada el 2026-09-22: link generado (vence el 2026-09-29 18:39), config publicada (`vio-client-makeupmekka-1`), 4 envs. **Faltan `SHOPIFY_API_SECRET`, conectar el Redis compartido y desplegar** |
